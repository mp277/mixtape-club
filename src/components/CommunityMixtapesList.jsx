...
/** CommunityMixtapesList component renders list of mixtapes created by the currently logged in user
 * at the mixtape-player route and is a child component of MixtapePlayer
 */

const CommunityMixtapesList = (props) => {
    const { searchResults, communityPlaylists, userName, tapeRefresh } = props;
    
    return (
        <ul className="list-group col-12 mx-auto my-mixtape-list">
            <li className="list-group-item active  border border-info bg-info">Community Mixtapes:</li>
...
export default CommunityMixtapesList;