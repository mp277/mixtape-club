...
function Container(props) {
    ...
    const { opts, isAuthenticated, authenticateUser, location, searchResults, onChange, onSearch, onGenerate, onPlayVideo, onReady, onPauseVideo,onStopRecordVideo, onRecordVideo, onBackward, onForward, onStopBackward, onStopForward, onResultClick, playing, recording, selectedResult, tapeImages, builderImage, selectImage, tapeLabel, onLabelChange, onPassToSideA, sideA, onPassToSideB, sideB, displayImageSelector, onSaveImage, onDeckSideA, onDeckSideB, onSavePlaylist, onMakePublic, tapeBackgroundColor, onDelete, isPublic, queryParam, googleId, onUserRecordingEnded, startRecordUser, stopRecordUser, recordUser, onKick, onSnare } = props;
